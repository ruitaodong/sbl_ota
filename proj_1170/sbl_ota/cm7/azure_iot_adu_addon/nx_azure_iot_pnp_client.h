...
typedef struct NX_AZURE_IOT_PNP_CLIENT_STRUCT
{
    ...
    UINT                                  (*nx_azure_iot_pnp_client_component_callback[NX_AZURE_IOT_PNP_CLIENT_MAX_PNP_COMPONENT_LIST])
                                                                                      (NX_AZURE_IOT_JSON_READER *json_reader_ptr,
                                                                                       ULONG version,
                                                                                       VOID *args);
    VOID                                   *nx_azure_iot_pnp_client_component_callback_args[NX_AZURE_IOT_PNP_CLIENT_MAX_PNP_COMPONENT_LIST];
