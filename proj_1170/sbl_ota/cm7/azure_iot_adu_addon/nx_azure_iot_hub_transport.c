    ...
    if (hub_transport_ptr -> nx_azure_iot_hub_transport_state == NX_AZURE_IOT_HUB_TRANSPORT_STATUS_CONNECTED)
    {
        ...
        if (hub_transport_ptr -> nx_azure_iot_hub_transport_connection_status_callback)
        {
            if (hub_transport_ptr -> nx_azure_iot_hub_transport_token_refresh &&
                (nx_azure_iot_unix_time_get(hub_transport_ptr -> nx_azure_iot_ptr,
                                            &current_time) == NX_AZURE_IOT_SUCCESS) &&
                (current_time > hub_transport_ptr -> nx_azure_iot_hub_transport_sas_token_expiry_time))
            {
...
az_result       core_result;
    ...
    if (hub_transport_ptr -> nx_azure_iot_hub_transport_token_refresh)
    {
        ...
        expiry_time_secs += NX_AZURE_IOT_HUB_TRANSPORT_TOKEN_CONNECTION_TIMEOUT;
        ...
        hub_transport_ptr -> nx_azure_iot_hub_transport_sas_token_expiry_time = expiry_time_secs;
    }
    else
    {
