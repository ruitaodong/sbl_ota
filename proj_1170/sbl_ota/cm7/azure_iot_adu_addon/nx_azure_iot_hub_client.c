...
typedef union NX_AZURE_IOT_HUB_CALLBACK
{
    NX_AZURE_IOT_HUB_TRANSPORT_GENERIC_FN nx_azure_iot_hub_transport_cb;
    VOID (*nx_azure_iot_hub_receive_cb)(NX_AZURE_IOT_HUB_CLIENT *hub_client_ptr, VOID *args);
    VOID (*nx_azure_iot_hub_connection_status_cb)(NX_AZURE_IOT_HUB_CLIENT *hub_client_ptr, UINT status);
    VOID (*nx_azure_iot_hub_receive_property_cb)(NX_AZURE_IOT_HUB_CLIENT *hub_client_ptr,
                                                 UINT request_id, UINT response_status,
                                                 ULONG version, VOID *arg);
} NX_AZURE_IOT_HUB_CALLBACK;
...
NX_AZURE_IOT_HUB_CLIENT *hub_client_ptr = (NX_AZURE_IOT_HUB_CLIENT *)hub_trans_ptr -> nx_azure_iot_hub_transport_client_context;
    ...
    return(az_iot_hub_client_get_client_id(&(hub_client_ptr -> iot_hub_client_core),
                                           (CHAR *)buffer, buffer_len, (size_t *)bytes_copied));
}
...
NX_AZURE_IOT_HUB_CLIENT *hub_client_ptr = (NX_AZURE_IOT_HUB_CLIENT *)hub_trans_ptr -> nx_azure_iot_hub_transport_client_context;
    ...
    return(az_iot_hub_client_sas_get_password(&(hub_client_ptr -> iot_hub_client_core),
                                              ...
                                              (CHAR *)out_buffer, out_buffer_len, (size_t *)bytes_copied));
}
...
{
NX_AZURE_IOT_HUB_CLIENT *hub_client_ptr = (NX_AZURE_IOT_HUB_CLIENT *)hub_trans_ptr -> nx_azure_iot_hub_transport_client_context;
NX_AZURE_IOT_HUB_CALLBACK callback_union;

    callback_union.nx_azure_iot_hub_transport_cb = arg1;
    callback_union.nx_azure_iot_hub_receive_cb(hub_client_ptr, arg2);
}
...
NX_AZURE_IOT_HUB_CALLBACK callback_union;
    ...
    callback_union.nx_azure_iot_hub_transport_cb = arg;
    callback_union.nx_azure_iot_hub_connection_status_cb(hub_client_ptr, status);
}
...
NX_AZURE_IOT_HUB_CALLBACK callback_union;
    ...
    {
        LogError(LogLiteralArgs("IoTHub parse twin failed: %d"), status);
        nx_packet_release(packet_ptr);
        return;
    }

    callback_union.nx_azure_iot_hub_transport_cb = arg1;
    callback_union.nx_azure_iot_hub_receive_property_cb(hub_client_ptr, request_id,
...
NX_AZURE_IOT_HUB_CALLBACK callback_union;
    ...
    callback_union.nx_azure_iot_hub_connection_status_cb = connection_status_cb;
    return(nx_azure_iot_hub_transport_connection_callback_set(&(hub_client_ptr -> nx_azure_iot_hub_client_transport),
                                                              ...
                                                              callback_union.nx_azure_iot_hub_transport_cb));
}
...
NX_AZURE_IOT_HUB_CALLBACK callback_union;
    ...
    callback_union.nx_azure_iot_hub_receive_cb = callback_ptr;
    ...
    return(nx_azure_iot_hub_transport_receive_message_callback_set(&(hub_client_ptr ->nx_azure_iot_hub_client_transport),
                                                                   ...
                                                                   callback_union.nx_azure_iot_hub_transport_cb, callback_args));
}
...
NX_AZURE_IOT_HUB_CALLBACK callback_union;
    ...
    callback_union.nx_azure_iot_hub_receive_property_cb = callback_ptr;
