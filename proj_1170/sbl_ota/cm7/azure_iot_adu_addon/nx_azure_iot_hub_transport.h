...
#ifndef NX_AZURE_IOT_HUB_TRANSPORT_TOKEN_CONNECTION_TIMEOUT
#ifdef NX_AZURE_IOT_HUB_CLIENT_TOKEN_EXPIRY
#define NX_AZURE_IOT_HUB_TRANSPORT_TOKEN_CONNECTION_TIMEOUT                     NX_AZURE_IOT_HUB_CLIENT_TOKEN_EXPIRY
#else
#define NX_AZURE_IOT_HUB_TRANSPORT_TOKEN_CONNECTION_TIMEOUT                     (3600)
#endif /* NX_AZURE_IOT_HUB_CLIENT_TOKEN_EXPIRY */
#endif /* NX_AZURE_IOT_HUB_TRANSPORT_TOKEN_CONNECTION_TIMEOUT */
...
typedef struct NX_AZURE_IOT_HUB_TRANSPORT_STRUCT
{
    ...
    ULONG                                                nx_azure_iot_hub_transport_sas_token_expiry_time;
