...
int main(void)
{
    ...
    board_setup();
    PRINTF("Start the azure_iot_adu example...\r\n");
    PRINTF("board_setup_extra\r\n");
    board_setup_extra();
...
UINT    i;
    ...
    status = nx_dns_host_by_name_get(&dns_0, (UCHAR *)sntp_servers[sntp_server_index], &sntp_server_address, 5 * NX_IP_PERIODIC_RATE);
